...
experimentID = 'RoboLab007_Lys100_Asp200_150mM_NaCl_2Dmatrix_1decimal_insilico_downsampling4_R1'
validated_datasetID = '{}_cycle_{}_validated_points.csv'
new_points_batch = 8
acquisition_mode = 'exploration'

# - gt
GT_DB = GT_FILE_PATH+'/RoboLab007_GT/RoboLab007_GT.csv'
...
if __name__ == '__main__':
    ...
    for cycle in range(N_CYCLES+1):
        ...
        experiment_cycle_dict_tmp = {
            ...
            'cycle_number' : None,
            'search_space_dataset': 'DOE_RoboLab007_Lys100_Asp200_150mM_NaCl_2Dmatrix_1decimal_insilico_downsampling4_R1_2Dim.csv',
