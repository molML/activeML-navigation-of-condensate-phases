...
experimentID = 'RoboLabSynt_2D_A'
validated_datasetID = '{}_cycle_{}_validated_points.csv'
new_points_batch = 10
acquisition_mode = 'exploration'

# - gt
GT_DB = GT_FILE_PATH+'/SyntheticPhaseDiagrams/SyntheticData_GT_A.csv'
...
if __name__ == '__main__':
    ...
    for cycle in range(N_CYCLES+1):
        ...
        experiment_cycle_dict_tmp = {
            ...
            'cycle_number' : None,
            'search_space_dataset': 'DOE_RoboLabSynt_2D_A_2Dim.csv',
        ...
        if cycle == 0:
            experiment_cycle_dict_tmp['sampling_mode'] = 'FPS'
            experiment_cycle_dict_tmp['new_points_batch'] = new_points_batch*2
