...
experimentID = 'RoboLab008_Lys100_Asp200_NaCl_Matrix_insilico_downsampling4_R1'
...
if __name__ == '__main__':
    ...
    for cycle in range(N_CYCLES+1):
        ...
        experiment_cycle_dict_tmp = {
            ...
            'cycle_number' : None,
            'search_space_dataset': 'DOE_RoboLab008_Lys100_Asp200_NaCl_Matrix_insilico_downsampling4_R1_3Dim.csv',
